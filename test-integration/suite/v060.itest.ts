// Integration tests for the v0.6.0 webview features (selection auto-attach,
...
// the tests are deterministic and need no Ollama / OpenCode.
...
describe('v0.6.0 webview features', function () {
  this.timeout(30000);
