...
// summarize ("/compact") call (captured from a live darwin-arm64 + Ollama run):
// a real turn, a `compaction` marker on a user message, the summarizer's own
// assistant turn, then a fresh real turn. Only the marker + summarizer turn must
// be hidden.
