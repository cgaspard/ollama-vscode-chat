...
declare const ollamaProviderOptions: z.ZodObject<{
    think: z.ZodOptional<z.ZodUnion<readonly [z.ZodBoolean, z.ZodString]>>;
...
interface OllamaProvider extends ProviderV4 {
  ...
  Creates an Ollama chat model for text generation.
     */
    chat(modelId: OllamaChatModelId, settings?: OllamaProviderOptions): LanguageModelV4;
    /**
  Creates an Ollama completion model for text generation.
     */
    completion(modelId: OllamaCompletionModelId, settings?: OllamaCompletionSettings): LanguageModelV4;
    /**
  Creates a model for text embeddings.
     */
    embedding(modelId: OllamaEmbeddingModelId, settings?: OllamaEmbeddingSettings): EmbeddingModelV4;
    /**
  Creates a model for text embeddings.
  
  @deprecated Use `textEmbeddingModel` instead.
     */
    textEmbedding(modelId: OllamaEmbeddingModelId, settings?: OllamaEmbeddingSettings): EmbeddingModelV4;
    /**
  Creates a model for text embeddings.
     */
    textEmbeddingModel(modelId: OllamaEmbeddingModelId, settings?: OllamaEmbeddingSettings): EmbeddingModelV4;
}
